...
class InstancesGeneration():
    ...
    def getExperimentsList(self, seed,optimization):
        experiments_list = [
            ...
            {"id":   "lvae_19", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_512_A_linear",  "epoch":{'AE':   50,'GAN':  1},  "univar_count":512,  "lat_dim":32,   "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            ...
            {"id":   "gvae_0512", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_512_A_graph",  "epoch":{'AE':  100,'GAN':  1},  "univar_count":512,    "lat_dim":130,  "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
