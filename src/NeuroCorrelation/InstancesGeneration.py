...
class InstancesGeneration():
    ...
    def limit_resource(self, gb_limit):
        ...
        cprint(Style.BRIGHT + "Memory limit set to {gb_limit} GB." + Style.RESET_ALL, 'magenta', attrs=["bold"])
        cprint(Style.BRIGHT + f"Current limit (soft): {soft / (1024 * 1024 * 1024):.2f} GB" + Style.RESET_ALL, 'magenta', attrs=["bold"])
        cprint(Style.BRIGHT + f"Current limit (hard): {hard / (1024 * 1024 * 1024):.2f} GB" + Style.RESET_ALL, 'magenta', attrs=["bold"])
    ...
    def getExperimentsList(self, seed,optimization):
        experiments_list = [
            {"id":   0, "model_case":"autoencoder_3_copula_optimization", "epoch":{'AE':   3,'GAN':   2}, "univar_count": 7, "lat_dim": 3,"prior_channels":1, "dataset_setting":{"batch_size":  32, "train_percentual":None,"starting_sample":None,"train_samples":None,"test_samples":None, "noise_samples":10000, "seed":seed}, "instaces_size" :1, "input_shape":"vector"},

            #METR-LA DATASET
            {"id":    1, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_METR_16",  "epoch":{'AE':    2,'GAN' :  1},  "univar_count":16,   "lat_dim":12,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   64,'GAN' :   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":    2, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_METR_32",  "epoch":{'AE':  100,'GAN' :  100},  "univar_count":32,   "lat_dim":28,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE' :  64,'GAN' :   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":    3, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_METR_48",  "epoch":{'AE':  100,'GAN' :  100},  "univar_count":48,   "lat_dim":36,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   64,'GAN' :   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":    4, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_METR_64",  "epoch":{'AE':  100,'GAN' :  100},  "univar_count":64,   "lat_dim":54,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   64,'GAN' :   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},

            #PEMS-BAY DATASET
            {"id":    5, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_PEMS_16",  "epoch":{'AE':  100,'GAN' :  100},  "univar_count":16,   "lat_dim":12,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':  128,'GAN' :  128}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":    6, "case":"PEMS_METR", "model_case":"AE>WGAN_linear_pretrained_PEMS_16",  "epoch":{'AE': 150,'WGAN':  150},  "univar_count":16,   "lat_dim":12,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   64,'WGAN':   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":    7, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_PEMS_32",  "epoch":{'AE':  100,'GAN' :  100},  "univar_count":32,   "lat_dim":28,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   64,'GAN' :   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":    8, "case":"PEMS_METR", "model_case":"AE>WGAN_linear_pretrained_PEMS_32",  "epoch":{'AE':  10,'WGAN' :  1000},  "univar_count":32,   "lat_dim":28,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':64,'WGAN' : 256}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            ...
            ##LINEAR 
            {"id":   "11", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_16_A_linear",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":16,   "lat_dim":6,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "12", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_32_A_linear",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":32,   "lat_dim":8,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "13", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_48_A_linear",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":48,   "lat_dim":10,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "14", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_64_A_linear",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":64,   "lat_dim":12,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "15", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_96_A_linear",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":96,   "lat_dim":16,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "16", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_128_A_linear",  "epoch":{'AE':   50,'GAN':  1},  "univar_count":128,  "lat_dim":20,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "lvae_17", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_192_A_linear",  "epoch":{'AE':   50,'GAN':  1},  "univar_count":192,  "lat_dim":24,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "lvae_18", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_256_A_linear",  "epoch":{'AE':   50,'GAN':  1},  "univar_count":256,  "lat_dim":30,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "lvae_19", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_512_A_linear",  "epoch":{'AE':   50,'GAN':  1},  "univar_count":512,  "lat_dim":32,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
             
            #GRAPH
            {"id":   "gvae_0016", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_16_A_graph",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":16,     "lat_dim":6,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0032", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_32_A_graph",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":32,     "lat_dim":8,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   264,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0048", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_48_A_graph",   "epoch":{'AE':   50,'GAN':  1},  "univar_count":48,     "lat_dim":10,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   264,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0064", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_64_A_graph",   "epoch":{'AE':  100,'GAN':  1},  "univar_count":64,     "lat_dim":12,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   264,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0096", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_96_A_graph",   "epoch":{'AE':  100,'GAN':  1},  "univar_count":96,     "lat_dim":16,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0128", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_128_A_graph",  "epoch":{'AE':  100,'GAN':  1},  "univar_count":128,    "lat_dim":24,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0192", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_192_A_graph",  "epoch":{'AE':  100,'GAN':  1},  "univar_count":192,    "lat_dim":64,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0256", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_256_A_graph",  "epoch":{'AE':  100,'GAN':  1},  "univar_count":256,    "lat_dim":90,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_0512", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_512_A_graph",  "epoch":{'AE':  100,'GAN':  1},  "univar_count":512,    "lat_dim":130, "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "gvae_1024", "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_1024_A_graph", "epoch":{'AE':  150,'GAN':  1},  "univar_count":1024,   "lat_dim":96,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            #B-VAE 
            {"id":   "bvae_0016_fix", "case":"CHENGDU_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_16_A_graph_kl_fix",     "epoch":{'VAE':  100},  "univar_count":16,   "lat_dim":6,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            ...
            {"id":   "bvae_0064_fix", "case":"CHENGDU_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_64_A_graph_kl_fix",     "epoch":{'VAE':  2},  "univar_count":64,   "lat_dim":12,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "bvae_0096_fix", "case":"CHENGDU_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_96_A_graph_kl_fix",     "epoch":{'VAE':  150},  "univar_count":96,   "lat_dim":16,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "bvae_0128_fix", "case":"CHENGDU_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_128_A_graph_kl_fix",     "epoch":{'VAE': 150},  "univar_count":128,   "lat_dim":24,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            {"id":   "bvae_0192_fix", "case":"CHENGDU_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_192_A_graph_kl_fix",     "epoch":{'VAE':  100},  "univar_count":192,   "lat_dim":36,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "bvae_0256_fix", "case":"CHENGDU_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_256_A_graph_kl_fix",     "epoch":{'VAE':  100},  "univar_count":256,   "lat_dim":52,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            {"id":   "3some", "case":"CHENGDU_SMALLGRAPH", "model_case":"3some",     "epoch":{'VAE':  2},  "univar_count":4,   "lat_dim":5,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   5}, "train_percentual":0.999,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":50, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},

            
            {"id":   28, "case":"CHENGDU_SMALLGRAPH", "model_case":"CVAE_CHENGDU_SMALLGRAPH_16_A_graph_kl_lin",     "epoch":{'CVAE':  100},  "univar_count":16,   "lat_dim":8,  "prior_channels":1, "dataset_setting":{"batch_size": {'CVAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            ...
            {"id":   24, "case":"CHENGDU_ZONE", "model_case":"AE_CHENGDU_URBAN_ZONE_0_graph",          "epoch":{'AE':  200,'GAN':  1},  "univar_count":248,   "lat_dim":80,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   2375,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            
            {"id":   "VAE_SP500_T3_lin", "case":"SP500", "model_case":"VAE_SP500_T3_linear",     "epoch":{'VAE':  100},  "univar_count":3,   "lat_dim":6,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            #B-VAE_SEOUL --> instances 1
            {"id":   "bvae_0016_seoul", "case":"SEOUL_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_16_A_graph_kl_fix",     "epoch":{'VAE':  100},  "univar_count":16,   "lat_dim":6,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':  16}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   "bvae_0025_seoul", "case":"SEOUL_SMALLGRAPH", "model_case":"VAE_CHENGDU_SMALLGRAPH_25_A_graph_kl_fix",     "epoch":{'VAE':  100},  "univar_count":25,   "lat_dim":8,  "prior_channels":1, "dataset_setting":{"batch_size": {'VAE':   16}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            #B-VAE_SEOUL --> instances 1
        ...
        '''
            {"id":   21, "case":"CHENGDU_ZONE", "model_case":"AE_CHENGDU_URBAN_ZONE_1_graph",          "epoch":{'AE':  50,'GAN':  1},  "univar_count":240,   "lat_dim":60,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   2375,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   22, "case":"CHENGDU_ZONE", "model_case":"AE_CHENGDU_URBAN_ZONE_2_graph",          "epoch":{'AE':  50,'GAN':  1},  "univar_count":197,   "lat_dim":24,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   2375,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   23, "case":"CHENGDU_ZONE", "model_case":"AE_CHENGDU_URBAN_ZONE_3_graph",          "epoch":{'AE':  50,'GAN':  1},  "univar_count":268,   "lat_dim":24,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   2375,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   24, "case":"CHENGDU_ZONE", "model_case":"AE_CHENGDU_URBAN_ZONE_1-2_graph",        "epoch":{'AE':  50,'GAN':  1},  "univar_count":437,   "lat_dim":36,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   2375,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":2375, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   25, "case":"CHENGDU_ZONE", "model_case":"AE_CHENGDU_URBAN_ZONE_1-2_graph",        "epoch":{'AE':  50,'GAN':  1},  "univar_count":437,   "lat_dim":36,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE':   2375,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            
            {"id":  24, "model_case":"ESG__GAN_linear_pretrained_35",  "epoch":{'AE': 100,'GAN': 2},  "univar_count":35,   "lat_dim":30,  "prior_channels":1, "dataset_setting":{"batch_size": {'AE': 2348,'GAN': 32}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"}
        '''
    ...
    def experiment(self, num_case, main_folder, seed, experiment_name, optimization, load_model, loss_obj, time_slot=None):
        ...
        cprint(Style.BRIGHT + f"| Experiment ID:\t {id_experiments}" + Style.RESET_ALL, 'cyan', attrs=["bold"])
        ...
        cprint(Style.BRIGHT + "| settings:" + Style.RESET_ALL, 'cyan', attrs=["bold"])
        stack = [(k, v, "") for k, v in experiments_selected.items()]
        while stack:
            k, v, prefix = stack.pop(0)
            full_key = f"{prefix}.{k}" if prefix else k
            if isinstance(v, dict):
                for subk, subv in v.items():
                    stack.append((subk, subv, full_key))
            else:
                cprint(Style.BRIGHT + f"| ▶\t{full_key:<30}: {v}" + Style.RESET_ALL, 'cyan', attrs=["bold"])
    ...
    def print_flat(d, prefix=""):
        for k, v in d.items():
            full_key = f"{prefix}.{k}" if prefix else k
            if isinstance(v, dict):
                print_flat(v, full_key)
            else:
                cprint(Style.BRIGHT + f"| ▲\t{full_key:<25}: {v}" + Style.RESET_ALL, 'cyan', attrs=["bold"])