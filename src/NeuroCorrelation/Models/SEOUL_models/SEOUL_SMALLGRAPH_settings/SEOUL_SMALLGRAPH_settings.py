...
class SEOUL_SMALLGRAPH_settings():
    ...
    def setting_model_case(self):
        ...
        if self.model_case == "VAE_SEOUL_SMALLGRAPH_16_A_graph_kl_fix":
            self.mode = "graph_roads"
            self.name_dataset = "SEOUL"
            self.version_dataset = "SMALLGRAPH_16"
            self.key_value_names = ['NO2']  
            self.nets = ['VAE']
        ...
        elif self.model_case == "VAE_SEOUL_SMALLGRAPH_25_NO2_A_graph_kl_fix":
            self.mode = "graph_roads"
            self.name_dataset = "SEOUL"
