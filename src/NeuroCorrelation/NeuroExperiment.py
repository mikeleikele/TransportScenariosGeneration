...
class NeuroExperiment():
    ...
    def getExperimentsList(self,seed,optimization):
        experiments_list = [
            ...
            {"id":   5, "case":"PEMS_METR", "model_case":"AE>GAN_linear_pretrained_PEMS_16",  "epoch":{'AE':  50,'GAN':  1000},  "univar_count":16,   "lat_dim":12,   "dataset_setting":{"batch_size": {'AE':  128,'GAN':  128}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            ...
            {"id":   9, "case":"CHENGDU", "model_case":"AE>GAN_linear_pretrained_CHENGDU_SMALLGRAPH_16_A",  "epoch":{'AE':  100,'GAN':  100},  "univar_count":16,   "lat_dim":12,   "dataset_setting":{"batch_size": {'AE':   64,'GAN':   64}, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
