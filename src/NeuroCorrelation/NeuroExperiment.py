...
class NeuroExperiment():
    ...
    def getExperimentsList(self,seed):
        experiments_list = [
            ...
            {"id":  2, "model_case":"GAN_linear_pretrained_16_METR_bt",   "epoch":{'AE': 2,'GAN': 2}, "univar_count":16, "lat_dim":12, "dataset_setting":{"batch_size":  32, "train_percentual":0.6,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":None, "seed":seed}, "instaces_size" :1, "input_shape":"vector"},            
