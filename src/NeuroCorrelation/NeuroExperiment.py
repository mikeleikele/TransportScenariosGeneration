...
class NeuroExperiment():
    ...
    def main(self, num_case, experiment_name_suffix, main_folder, repeation, load_model=None, train_models="yes"):
        ...
        for seed in range(0, int(repeation)):
            ...
            #aResult = AnalysisResults(univar_count)
    ...
    def getExperimentsList(self,seed):
        experiments_list = [
            ...
            {"id":   1, "model_case":"GAN_linear_pretrained_16_METR_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":16,   "lat_dim":12,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            {"id":   2, "model_case":"GAN_linear_pretrained_32_METR_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":32,   "lat_dim":22,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            {"id":   3, "model_case":"GAN_linear_pretrained_48_METR_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":48,   "lat_dim":36,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            {"id":   4, "model_case":"GAN_linear_pretrained_64_METR_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":64,   "lat_dim":48,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            
            {"id":   5, "model_case":"GAN_linear_pretrained_16_PEMS_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":16,   "lat_dim":12,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            {"id":   6, "model_case":"GAN_linear_pretrained_32_PEMS_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":32,   "lat_dim":30,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            {"id":   7, "model_case":"GAN_linear_pretrained_48_PEMS_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":48,   "lat_dim":44,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
            {"id":   8, "model_case":"GAN_linear_pretrained_64_PEMS_bt",  "epoch":{'AE': 200,'GAN': 200},  "univar_count":64,   "lat_dim":60,   "dataset_setting":{"batch_size": {'AE': 3854,'GAN': 3854}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": True, "input_shape":"vector"},                                
