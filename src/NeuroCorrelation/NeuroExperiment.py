...
class NeuroExperiment():
    ...
    def __init__(self, num_case, folder, seed, load_model=None):
        ...
        experiments_list = [
            ...
            {"id":  2, "model_case":"GAN_linear_pretrained_16_METR_bt",   "epoch":{'AE':  50,'GAN':  50}, "univar_count":16, "lat_dim":12, "dataset_setting":{"batch_size": 128, "train_percentual":0.5,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":None, "seed":seed}, "instaces_size" :1, "input_shape":"vector"},            
            {"id":  3, "model_case":"GAN_linear_pretrained_16_CHENGDU_bt","epoch":{'AE':  50,'GAN':  50}, "univar_count":16, "lat_dim":12, "dataset_setting":{"batch_size": 128, "train_percentual":0.5,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":None, "seed":seed}, "instaces_size" :1, "input_shape":"vector"},
            {"id":  6, "model_case":"GAN_linear_pretrained_0064_Chengdu", "epoch":{'AE':  50,'GAN':  50}, "univar_count":64, "lat_dim":48, "dataset_setting":{"batch_size":  32, "train_percentual":None,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":None, "seed":seed}, "instaces_size" :1, "input_shape":"vector"}
        ]
