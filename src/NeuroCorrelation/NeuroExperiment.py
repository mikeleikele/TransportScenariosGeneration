...
class NeuroExperiment():
    ...
    def main(self, num_case, experiment_name_suffix, main_folder, repeation, load_model=None, time_slot=None, train_models="yes", optimization=False):
        ...
        seed_start = 1
        seed_end  = seed_start + int(repeation)
    ...
    def getExperimentsList(self,seed,optimization):
        experiments_list = [
            ...
            {"id":   12, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_16_A_graph",   "epoch":{'AE':  30,'GAN':  1},  "univar_count":16,   "lat_dim":6,   "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   13, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_32_A_linear",  "epoch":{'AE':  50,'GAN':  1},  "univar_count":32,   "lat_dim":8,   "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   14, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_32_A_graph",   "epoch":{'AE':  50,'GAN':  1},  "univar_count":32,   "lat_dim":8,   "dataset_setting":{"batch_size": {'AE':    256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   15, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_48_A_linear",  "epoch":{'AE':  50,'GAN':  1},  "univar_count":48,   "lat_dim":10,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   16, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_48_A_graph",   "epoch":{'AE':  50,'GAN':  1},  "univar_count":48,   "lat_dim":10,   "dataset_setting":{"batch_size": {'AE':   264,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            ...
            {"id":   18, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_64_A_graph",   "epoch":{'AE':  100,'GAN':  1},  "univar_count":64,   "lat_dim":12,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            {"id":   19, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_128_A_graph",   "epoch":{'AE':  2,'GAN':  1},  "univar_count":128,   "lat_dim":24,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   20, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_192_A_graph",   "epoch":{'AE':  100,'GAN':  1},  "univar_count":192,   "lat_dim":80,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            {"id":   21, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_256_A_graph",   "epoch":{'AE':  25,'GAN':  1},  "univar_count":256,   "lat_dim":90,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   22, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_512_A_graph",   "epoch":{'AE':  30,'GAN':  1},  "univar_count":512,   "lat_dim":130,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            {"id":   23, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_1024_A_graph",  "epoch":{'AE':  50,'GAN':  1},  "univar_count":1024,   "lat_dim":96,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
            
            {"id":   24, "case":"CHENGDU_SMALLGRAPH", "model_case":"AE>GAN_CHENGDU_SMALLGRAPH_96_A_graph",  "epoch":{'AE':  50,'GAN':  1},  "univar_count":96,   "lat_dim":14,   "dataset_setting":{"batch_size": {'AE':   256,'GAN':   256}, "train_percentual":0.9,"starting_sample":None,"train_samples":None,"test_samples":None,"noise_samples":10000, "seed":seed}, "instaces_size" :1,"optimization": optimization, "input_shape":"vector"},
        ...
        optimization_settings = {
            ...
            "search_space":[
                ...
                {"type":"Real","min":5e-5,"max":2, "values_list":None, "name":"loss", "network_part":"AE",  "param":"VARIANCE_LOSS"},
